          ...
          <h2 class="title">Shopping Cart</h2>
            <div class="table-responsive form-group">
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    <td class="text-center"><a href="product.html"><img width="70px" src="resources/image/catalog/demo/product/funiture/8.jpg" alt="Aspire Ultrabook Laptop" title="Aspire Ultrabook Laptop" class="img-thumbnail" /></a></td>
                  ...
                  <tr>
                    <td class="text-center"><a href="product.html"><img width="70px" src="resources/image/catalog/demo/product/funiture/10.jpg" alt="Xitefun Causal Wear Fancy Shoes" title="Xitefun Causal Wear Fancy Shoes" class="img-thumbnail" /></a></td>
