...
--
-- Хост: 127.0.0.1
-- Время создания: Сен 14 2023 г., 15:55
...
(1, '/?route=index/index', 'Главная', 3, NULL, NULL, NULL),
(2, '/?route=index/page&id=2', 'Контакты', 3, NULL, NULL, NULL),
(3, '/?route=index/category&id=5', 'Смартфоны', 3, NULL, NULL, NULL),
(4, '/?route=index/category&id=6', 'Компьютеры', 3, NULL, NULL, NULL),
(5, '/?route=index/page&id=1', 'О нас', 3, NULL, NULL, NULL),
(6, '/?route=index/category&id=5', 'Смартфоны', 2, NULL, NULL, NULL),
(7, '/?route=index/index', 'Главная', 2, NULL, NULL, NULL),
(8, '/?route=index/page&id=2', 'Контакты', 2, NULL, NULL, NULL),
(9, '/?route=index/category&id=6', 'Компьютеры', 2, NULL, NULL, NULL),
(10, '/?route=index/page&id=1', 'О нас', 2, NULL, NULL, NULL);
...
(5, '', 'Смартфоны', NULL, 'контент Смартфоны'),
(6, '', 'Компьютеры', NULL, 'контент Компьютеры');
...
(1, 'ПК DEXP Atlas H342', 'PC1_1.jpg', 'Intel Celeron N4120, 4 x x1.1 ГГц, 4 ГБ DDR4, SSD 128 ГБ, без ОС', 6, 7799, NULL, 'PC1_1.jpg', 'PC1_2.jpg', 'PC1_3.jpg'),
(2, 'Сотовый телефон teXet TM-130 красный', 'Ph1_1.png', '2SIM, 1.77\", TN (TFT), 128x160, FM, micro SD, 600 мА*ч', 5, 1099, NULL, 'Ph1_1.png', 'Ph1_2.png', 'Ph1_3.png'),
(3, 'ПК HP OMEN GT22-0005ur [5D449EA]', 'PC2_1.png', 'Intel Core i9-12900K, 8 x x3.2 ГГц, 64 ГБ DDR4, GeForce RTX 3080 Ti, SSD 2000 ГБ, Windows 11 Home Single Language', 6, 541999, NULL, 'PC2_1.png', 'PC2_2.png', 'PC2_3.png'),
(4, '5.5\" Смартфон Black Fox B2 Fox 8 ГБ голубой', 'Ph2_2.png', 'ядер - 4x(1.4 ГГц), 1 Гб, 2 SIM, IPS, 1440x720, камера 8 Мп, 4G, GPS, 2200 мА*ч', 5, 2999, 3499, 'Ph2_1.png', 'Ph2_3.png', 'Ph2_4.png'),
(5, '6.7\" Смартфон Apple iPhone 14 Pro Max 1024 ГБ золотистый', 'Ph3_1.png', 'ядер - 6, 6 Гб, OLED, 2796x1290, камера 48+12+12 Мп, NFC, 5G, GPS', 5, 174799, 189999, 'Ph3_1.png', 'Ph3_2.png', 'Ph3_3.png'),
(6, 'Мини ПК Apple Mac mini', 'PC3_1.png', 'Apple M2, 4 x x3.5 ГГц, 8 ГБ, SSD 256 ГБ, macOS', 6, 70799, 76999, 'PC3_1.png', 'PC3_2.png', 'PC3_3.png'),
(7, '6.1\" Смартфон Apple iPhone 13 128 ГБ черный', 'Ph4_1.png', 'ядер - 6x(1.8 ГГц, 3.2 ГГц), 4 Гб, 2 SIM, OLED, 2532x1170, камера 12+12 Мп, NFC, 5G, GPS ', 5, 73599, 79999, 'Ph4_1.png', 'Ph4_2.png', 'Ph4_3.png');
...
(1, '1@mail.ru', 'Максим', 'Алексеев', '202cb962ac59075b964b07152d234b70');
